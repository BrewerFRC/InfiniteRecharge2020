...
public class Constants {
    //PWM
    static final int PWM_INTAKE_MOTOR = 0, PWM_COLORWHEEL_MOTOR = 1, PWM_MAGAZINE_MOTOR = 2, PWM_LEFT_CLIMBER = 3, PWM_RIGHT_CLIMBER = 4 , PWM_LEFT_RACHET= 5, PWM_RIGHT_RACHET = 6, PWM_LED = 7;
